...
# App description
st.markdown(
    "<p style='color:#E65C4F; font-style:italic; font-weight:bold; text-align:center;'>Effortlessly translate any text into your chosen language and hear it spoken aloud.</p>",
    unsafe_allow_html=True
)
